// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":62633}
"use strict";
(() => {
...
var $author$project$Main$AvorionMsg = function (a) {
	return {$: 'AvorionMsg', a: a};
};
var $author$project$Avorion$Raw = {$: 'Raw'};
var $author$project$Avorion$GotEconomy = function (a) {
	return {$: 'GotEconomy', a: a};
};
var $author$project$Avorion$GoodInfo = F2(
	function (cost, soldBy) {
		return {cost: cost, soldBy: soldBy};
	});
...
var $author$project$Avorion$decodeGoodInfo = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Avorion$GoodInfo,
...
var $author$project$Avorion$economyDecoder = $elm$json$Json$Decode$dict($author$project$Avorion$decodeGoodInfo);
...
var $author$project$Avorion$initCmd = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Avorion$GotEconomy, $author$project$Avorion$economyDecoder),
		url: '../json/economy.json'
	});
var $author$project$Avorion$init = function (_v0) {
	return _Utils_Tuple2(
		{display: $author$project$Avorion$Raw, economy: $elm$core$Maybe$Nothing, showDollar: true},
		$author$project$Avorion$initCmd);
};
var $author$project$Main$CounterSect = {$: 'CounterSect'};
var $author$project$Book$NotStarted = {$: 'NotStarted'};
var $author$project$Book$init = {bookState: $author$project$Book$NotStarted, gotItems: $elm$core$Maybe$Nothing};
var $author$project$Main$initialState = function (avorionModel) {
	return {avorionModel: avorionModel, bookModel: $author$project$Book$init, counter: 0, display: $author$project$Main$CounterSect};
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$init = function (_v0) {
	var _v1 = $author$project$Avorion$init(_Utils_Tuple0);
	var am = _v1.a;
	var aCmd = _v1.b;
	return _Utils_Tuple2(
		$author$project$Main$initialState(am),
		A2($elm$core$Platform$Cmd$map, $author$project$Main$AvorionMsg, aCmd));
};
...
var $author$project$Avorion$Interactive = {$: 'Interactive'};
var $author$project$Avorion$Table = {$: 'Table'};
var $author$project$Shared$errorToString = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var url = error.a;
...
var $author$project$Avorion$dumpEconomy = function (httpRes) {
	if (httpRes.$ === 'Ok') {
		var v = httpRes.a;
		return A2($elm$core$Debug$log, 'Got economy!', _Utils_Tuple0);
	} else {
		var e = httpRes.a;
		return A2(
			$elm$core$Debug$log,
			'Failed to get economy and/or deserialize:' + $author$project$Shared$errorToString(e),
			_Utils_Tuple0);
	}
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Avorion$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotEconomy') {
			var httpRes = msg.a;
			var _v1 = $author$project$Avorion$dumpEconomy(httpRes);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						economy: $elm$core$Maybe$Just(httpRes)
					}),
			...
			switch (msg.a.$) {
				case 'GoInteractive':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{display: $author$project$Avorion$Interactive}),
						$elm$core$Platform$Cmd$none);
				case 'GoTable':
					var _v3 = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{display: $author$project$Avorion$Table}),
						$elm$core$Platform$Cmd$none);
				default:
					var _v4 = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{display: $author$project$Avorion$Raw}),
						$elm$core$Platform$Cmd$none);
			}
		}
	});
var $author$project$Book$Finished = function (a) {
	return {$: 'Finished', a: a};
};
var $author$project$Book$Started = {$: 'Started'};
...
var $author$project$Book$getBook = $elm$http$Http$get(
	{
		expect: $elm$http$Http$expectString($author$project$Book$GotBook),
			...
			case 'GetBook':
				return A2(
					...
					_Utils_Tuple2(
						_Utils_update(
							model,
							{bookState: $author$project$Book$Started}),
						$author$project$Book$getBook));
			case 'GotBook':
				var x = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bookState: $author$project$Book$Finished(x)
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$updateCounter = F2(
	function (msg, model) {
		if (msg.$ === 'Increment') {
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Main$AvorSect = {$: 'AvorSect'};
var $author$project$Main$BookSect = {$: 'BookSect'};
		...
		switch (msg.$) {
			case 'GoCounter':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{display: $author$project$Main$CounterSect}),
					$elm$core$Platform$Cmd$none);
			case 'GoBook':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{display: $author$project$Main$BookSect}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{display: $author$project$Main$AvorSect}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MenuMsg':
				var mMsg = msg.a;
				return A2($author$project$Main$updateMenu, mMsg, model);
			case 'CounterMsg':
				var cMsg = msg.a;
				return A2($author$project$Main$updateCounter, cMsg, model);
			case 'BookMsg':
				var bMsg = msg.a;
				var _v1 = A2($author$project$Book$update, bMsg, model.bookModel);
				var bModel = _v1.a;
				var bCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bookModel: bModel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$BookMsg, bCmd));
			case 'AvorionMsg':
				var aMsg = msg.a;
				var _v2 = A2($author$project$Avorion$update, aMsg, model.avorionModel);
				var aModel = _v2.a;
				var aCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Avorion$encodeGoodInfo = function (gi) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'cost',
				$elm$json$Json$Encode$int(gi.cost)),
				_Utils_Tuple2(
				'soldBy',
				$elm$json$Json$Encode$string(
					A2($elm$core$Maybe$withDefault, '', gi.soldBy)))
			]));
};
var $author$project$Avorion$encodeEconomy = function (ec) {
	return A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Avorion$encodeGoodInfo, ec);
};
...
var $author$project$Shared$splitAt = F2(
	function (i, list) {
...
var $author$project$Shared$formatInt = function (x) {
	return A2(
		$elm$core$String$join,
		',',
...
var $author$project$Shared$formatMoney = function (x) {
	return '$' + $author$project$Shared$formatInt(x);
};
...
var $author$project$Avorion$viewBody = F2(
	function (model, e) {
					...
					_List_fromArray(
						[
							...
							A2(
								...
								0,
								$author$project$Avorion$encodeEconomy(e)))
						]));
			case 'Table':
				return A2(
					$elm$html$Html$table,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														model.showDollar ? $author$project$Shared$formatMoney(v.cost) : $author$project$Shared$formatInt(v.cost))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(
														A2($elm$core$Maybe$withDefault, '', v.soldBy))
													]))
											]));
								},
...
var $author$project$Avorion$GoInteractive = {$: 'GoInteractive'};
var $author$project$Avorion$GoRaw = {$: 'GoRaw'};
var $author$project$Avorion$GoTable = {$: 'GoTable'};
var $author$project$Avorion$MenuMsg = function (a) {
	return {$: 'MenuMsg', a: a};
};
...
var $author$project$Avorion$createMenu = F3(
	function (isSelected, msg, title) {
		return isSelected ? A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Avorion$MenuMsg(msg))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(title)
...
var $author$project$Avorion$viewMenu = function (display) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3(
								$author$project$Avorion$createMenu,
								_Utils_eq(display, $author$project$Avorion$Interactive),
								$author$project$Avorion$GoInteractive,
								'Interactive')
							])),
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								A3(
								$author$project$Avorion$createMenu,
								_Utils_eq(display, $author$project$Avorion$Table),
								$author$project$Avorion$GoTable,
								'Table')
							])),
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								A3(
								$author$project$Avorion$createMenu,
								_Utils_eq(display, $author$project$Avorion$Raw),
								$author$project$Avorion$GoRaw,
								'Raw')
							]))
					]))
			]));
};
var $author$project$Avorion$view = function (model) {
	var _v0 = model.economy;
	if (_v0.$ === 'Nothing') {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('No Economy loaded')
				]));
	} else {
		if (_v0.a.$ === 'Err') {
			var e = _v0.a.a;
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Shared$errorToString(e))
					]));
		} else {
			var ec = _v0.a.a;
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Avorion$viewMenu(model.display),
						A2($author$project$Avorion$viewBody, model, ec)
					]));
		}
	}
};
var $author$project$Book$getBookStateText = function (bs) {
	switch (bs.$) {
		case 'NotStarted':
			return 'Nothing';
		case 'Started':
		...
		default:
			if (bs.a.$ === 'Ok') {
				...
				var e = bs.a.a;
				return $author$project$Shared$errorToString(e);
			}
	}
};
var $author$project$Book$GetBook = {$: 'GetBook'};
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$Book$btnFetchBook = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Book$GetBook)
		]),
	_List_fromArray(
		[
			$elm$html$Html$text('GetBook')
		]));
var $elm$html$Html$Attributes$class = $elm$html$Html$Attributes$stringProperty('className');
var $author$project$Book$viewBookState = function (bs) {
	switch (bs.$) {
		case 'NotStarted':
			return $author$project$Book$btnFetchBook;
		case 'Started':
			return A2($elm$html$Html$div, _List_Nil, _List_Nil);
		default:
			if (bs.a.$ === 'Ok') {
				...
				return A2(
					...
					_List_fromArray(
						[
							$author$project$Book$btnFetchBook,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Book$getBookStateText(model.bookState))
					])),
				$author$project$Book$viewBookState(model.bookState)
			]));
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$CounterMsg($author$project$Main$Decrement))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$CounterMsg($author$project$Main$Increment))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('+')
...
var $author$project$Main$GoAvorion = {$: 'GoAvorion'};
var $author$project$Main$GoBook = {$: 'GoBook'};
var $author$project$Main$GoCounter = {$: 'GoCounter'};
var $author$project$Main$MenuMsg = function (a) {
	return {$: 'MenuMsg', a: a};
};
var $author$project$Main$createMenu = F3(
	function (isSelected, msg, title) {
		return isSelected ? A2(
			$elm$html$Html$a,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('#'),
					$elm$html$Html$Events$onClick(
					$author$project$Main$MenuMsg(msg))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(title)
					...
					[
						...
						_List_fromArray(
							[
								...
								_Utils_eq(model.display, $author$project$Main$CounterSect),
								$author$project$Main$GoCounter,
								'Counter')
							])),
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								A3(
								$author$project$Main$createMenu,
								_Utils_eq(model.display, $author$project$Main$BookSect),
								$author$project$Main$GoBook,
								'Book')
							])),
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								A3(
								$author$project$Main$createMenu,
								_Utils_eq(model.display, $author$project$Main$AvorSect),
								$author$project$Main$GoAvorion,
								'Avorion')
							]))
					]))
			]));
...
var $author$project$Main$view = function (model) {
	var subv = function () {
		...
		switch (_v0.$) {
			case 'BookSect':
				var v = $author$project$Book$view(model.bookModel);
				return A2($elm$html$Html$map, $author$project$Main$BookMsg, v);
			case 'CounterSect':
				return $author$project$Main$viewCounter(model);
			default:
				var v = $author$project$Avorion$view(model.avorionModel);
				return A2($elm$html$Html$map, $author$project$Main$AvorionMsg, v);
		}
	}();
	return A2(
		$elm$html$Html$div,
